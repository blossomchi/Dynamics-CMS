<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CommitteeDefine.aspx.vb" Inherits="CommitteeDefine" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Commitee Define</title>
         ...
         <p>
            ...
            <div class="formframe">
                <div class="form-group">
                    <asp:Label ID="Label1" runat="server" Text="Commitee Name" CssClass="label"></asp:Label>
            ...
            <asp:GridView ID="gridLocation" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="SqlDataSource1" Font-Size="Medium" Height="30px" Width="441px" AllowPaging="True" AllowSorting="True" ForeColor="#333333" GridLines="None" PageSize="6">
                <AlternatingRowStyle BackColor="White" />
                <Columns>
                    <asp:BoundField DataField="SN" HeaderText="SN" ReadOnly="True" SortExpression="SN" InsertVisible="False" />
                    <asp:BoundField DataField="ComName" HeaderText="Committe" SortExpression="ComName" />
                    <asp:BoundField DataField="ComDescp" HeaderText="Description" SortExpression="ComDescp" />
                </Columns>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ChurchdbConnectionString %>" SelectCommand="SELECT [SN], [ComName], [ComDescp] FROM [CommTable]"></asp:SqlDataSource>
