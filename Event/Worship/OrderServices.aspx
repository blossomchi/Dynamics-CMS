<%@ Page Language="VB" AutoEventWireup="false" CodeFile="OrderServices.aspx.vb" Inherits="OrderServices" %>
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:Button ID="Button3" runat="server" Text="View Services " class="a_demo_one"  Width="160px" Height="40px" />
         <p>
           ...
           <div class="NewFrame">
                ...
                <div class="form-group">
                    <asp:Label ID="Label7" runat="server" Text="Mins" CssClass="label"></asp:Label>
                    <asp:TextBox ID="txtMins"  runat="server" CssClass="input" AutoPostBack="True" ReadOnly="True"></asp:TextBox>
                </div>

 <div class="form-group">
                    <asp:Label ID="Label9" runat="server" Text="Click To Calculate Mins" CssClass="label"></asp:Label>
                    <asp:ImageButton ID="ImageButton1" runat="server" Height="43px" ImageUrl="~/Event/Worship/Images/mins.png" Width="52px" />
