...
Partial Class Tithe
    ...
    Protected Sub DrpMember_SelectedIndexChanged(sender As Object, e As EventArgs) Handles DrpChurches.SelectedIndexChanged
        ...
        '               Where s.SN = DrpChurches.SelectedValue
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        Dim id = From i In a.HierarchyTables
                 Select i
        If id.Count > 0 Then
        ...
        Dim savetithe As New HierarchyTable With { _
        ...
        a.HierarchyTables.InsertOnSubmit(savetithe)
        a.SubmitChanges()

        If DropPayment.SelectedValue = "Cash" Then

            Dim savepayment As New HierarchyPaymentTable With { _
              .Titheid = Lblid.Text, _
              .Incomeid = drpGiving.SelectedValue, _
              .Datecreated = strDate, _
              .PaymentMethodid = txtcashM.Text, _
              .Amount = Text1.Text}
            a.HierarchyPaymentTables.InsertOnSubmit(savepayment)
            a.SubmitChanges()
        ...
        ElseIf DropPayment.SelectedValue = "Card" Then
            ...
            Dim saveBank As New HierarcyBankPaymentTable With { _
            .Titheid = Lblid.Text, _
           ...
           .CardNumber = TtxcardNo.Text, _
            ...
            .Datecreated = strDate}
            a.HierarcyBankPaymentTables.InsertOnSubmit(saveBank)
            a.SubmitChanges()
        ...
        Dim message As String = "Hierary Tithe Record, Added Successfully!"
        Dim url As String = "HierarchyTithe.aspx" ' The page tobe refreshed here!
    ...
    Public Sub AccountPosting()
        Dim getPaymentPerID = From g In madd.HierarchyPaymentTables
        ...
        If hasCash Then
            ...
            Call PostingHierarchyTitheAccount(strDate, CBHierarchy.SelectedValue, DrpChurches.SelectedValue, drpGiving.SelectedValue, "Cash", Lblid.Text, "CR", CashAmount, txtName1.Text)
        ...
        ElseIf hasCard Then
            ...
            Call PostingHierarchyTitheAccount(strDate, CBHierarchy.SelectedValue, DrpChurches.SelectedValue, drpGiving.SelectedValue, "Cash", Lblid.Text, "CR", CardAmount, "")
        ...
        ElseIf hasChegue Then
            ...
            Call PostingHierarchyTitheAccount(strDate, CBHierarchy.SelectedValue, DrpChurches.SelectedValue, drpGiving.SelectedValue, "Cash", Lblid.Text, "CR", ChequeAmount, "")
        ...
        ElseIf hasBankPayment Then
            ...
            Call PostingHierarchyTitheAccount(strDate, CBHierarchy.SelectedValue, DrpChurches.SelectedValue, drpGiving.SelectedValue, "Cash", Lblid.Text, "CR", pidBankPayment, "")
        ...
        ElseIf hasETransfer Then
            ...
            Call PostingHierarchyTitheAccount(strDate, CBHierarchy.SelectedValue, DrpChurches.SelectedValue, drpGiving.SelectedValue, "Cash", Lblid.Text, "CR", ETransferAmount, "")
    ...
    End Sub
    Public Sub PostingHierarchyTitheAccount(ByVal TDate As Date, HirerchyID As String, ChurchDetailsID As String, _
                                            IncomeID As Integer, Account As String, ADetails As String, _
                                            TType As String, Amount As Integer, Remark As String)
        Dim staff = txtStaffID.Text

        Dim SavePosting As New HierarcyAccountTable With { _
            ...
            .Datecreated = Now, _
            .StaffId = staff}
        madd.HierarcyAccountTables.InsertOnSubmit(SavePosting)
        madd.SubmitChanges()
    ...
    Protected Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        Response.Redirect("ViewHierarchyTithe.aspx")
    End Sub
