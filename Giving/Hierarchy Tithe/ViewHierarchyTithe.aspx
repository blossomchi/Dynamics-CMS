<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ViewHierarchyTithe.aspx.vb" Inherits="ViewTithe" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Hierarchy Tithe View</title>
...
<asp:Menu ID="Menu" runat="server" DataSourceID="SiteMapDataSource1" Orientation="Horizontal"
   OnMenuItemDataBound="OnMenuItemDataBound">
    ...
    <div class="main">
          <div>
            &nbsp;<asp:Button ID="Button2" runat="server" Text="Enter Church Tithe"  class="a_demo_one" style="font-style: italic; font-weight: 700; width: 201px;" Height="40px" ToolTip="Click to enter church tithe records." />
            &nbsp;&nbsp;<br />
            <br />
            </div>
    ...
    <div>
                ...
                <asp:ListItem>Tithe No</asp:ListItem>
            </asp:DropDownList>
        ...
        <div>
            <asp:GridView ID="gridAscending" runat="server" Width="1150px" DataSourceID="SqlDataSource1" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="6" ForeColor="#333333" GridLines="None" PageSize="20" ShowFooter="True" style="font-size: small; font-weight: 700;" CellSpacing="2" BorderStyle="Solid">
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Enterby" HeaderText="Entered by" ReadOnly="True" SortExpression="Enterby" />
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ChurchdbConnectionString %>" SelectCommand="SELECT HierarchyTable.SN, ChurchDesignationTable.Branch, ChurchDetailTable.ChurchName, IncomeTable.Income, HierarchyTable.TitheNo, HierarchyTable.Year, HierarchyTable.Month, HierarchyTable.Week, HierarchyTable.Amountword, MembershipTable.FirstName + ' ' + MembershipTable.LastName AS Enterby, HierarchyTable.Datecreated FROM IncomeTable INNER JOIN HierarchyTable ON IncomeTable.ID = HierarchyTable.Incomeid INNER JOIN MembershipTable ON HierarchyTable.Staffid = MembershipTable.Memberid INNER JOIN ChurchDesignationTable ON HierarchyTable.HierachyID = ChurchDesignationTable.ChurchDesgID INNER JOIN ChurchDetailTable ON HierarchyTable.ChurchDetailID = ChurchDetailTable.ChurchDetailID AND ChurchDesignationTable.ChurchDesgID = ChurchDetailTable.ChurchDesgID">
            </asp:SqlDataSource>
            ...
            <asp:GridView ID="gridDate" runat="server" Width="1150px" DataSourceID="SqlDataSource2" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="6" ForeColor="#333333" GridLines="None" PageSize="20" ShowFooter="True" style="font-size: small; font-weight: 700;" CellSpacing="2" BorderStyle="Solid">
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Income" HeaderText="Income" SortExpression="Income" />
                    <asp:BoundField DataField="TitheNo" HeaderText="TitheNo" SortExpression="TitheNo" />
                    <asp:BoundField DataField="Year" HeaderText="Year" SortExpression="Year" />
                    <asp:BoundField DataField="Month" HeaderText="Month" SortExpression="Month" />
                    <asp:BoundField DataField="Week" HeaderText="Week" SortExpression="Week" />
                    <asp:BoundField DataField="Amountword" HeaderText="Amount In Word" SortExpression="Amountword" />
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ChurchdbConnectionString %>" SelectCommand="SELECT HierarchyTable.SN, ChurchDesignationTable.Branch, ChurchDetailTable.ChurchName, IncomeTable.Income, HierarchyTable.TitheNo, HierarchyTable.Year, HierarchyTable.Month, HierarchyTable.Week, HierarchyTable.Amountword, MembershipTable.FirstName + ' ' + MembershipTable.LastName AS Enterby, HierarchyTable.Datecreated, HierarchyTable.Churchid FROM IncomeTable INNER JOIN HierarchyTable ON IncomeTable.ID = HierarchyTable.Incomeid INNER JOIN MembershipTable ON HierarchyTable.Staffid = MembershipTable.Memberid INNER JOIN ChurchDesignationTable ON HierarchyTable.HierachyID = ChurchDesignationTable.ChurchDesgID INNER JOIN ChurchDetailTable ON HierarchyTable.ChurchDetailID = ChurchDetailTable.ChurchDetailID AND ChurchDesignationTable.ChurchDesgID = ChurchDetailTable.ChurchDesgID WHERE (HierarchyTable.Datecreated = @date) AND (HierarchyTable.Churchid = @chu)">
                <SelectParameters>
            ...
            <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:ChurchdbConnectionString %>" SelectCommand="SELECT HierarchyTable.SN, ChurchDesignationTable.Branch, ChurchDetailTable.ChurchName, IncomeTable.Income, HierarchyTable.TitheNo, HierarchyTable.Year, HierarchyTable.Month, HierarchyTable.Week, HierarchyTable.Amountword, MembershipTable.FirstName + ' ' + MembershipTable.LastName AS Enterby, HierarchyTable.Datecreated FROM IncomeTable INNER JOIN HierarchyTable ON IncomeTable.ID = HierarchyTable.Incomeid INNER JOIN MembershipTable ON HierarchyTable.Staffid = MembershipTable.Memberid INNER JOIN ChurchDesignationTable ON HierarchyTable.HierachyID = ChurchDesignationTable.ChurchDesgID INNER JOIN ChurchDetailTable ON HierarchyTable.ChurchDetailID = ChurchDetailTable.ChurchDetailID AND ChurchDesignationTable.ChurchDesgID = ChurchDetailTable.ChurchDesgID WHERE (HierarchyTable.Month = @Month) AND (HierarchyTable.Churchid = @chu)">
                <SelectParameters>
            ...
            <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:ChurchdbConnectionString %>" SelectCommand="SELECT HierarchyTable.SN, ChurchDesignationTable.Branch, ChurchDetailTable.ChurchName, IncomeTable.Income, HierarchyTable.TitheNo, HierarchyTable.Year, HierarchyTable.Month, HierarchyTable.Week, HierarchyTable.Amountword, MembershipTable.FirstName + ' ' + MembershipTable.LastName AS Enterby, HierarchyTable.Datecreated FROM IncomeTable INNER JOIN HierarchyTable ON IncomeTable.ID = HierarchyTable.Incomeid INNER JOIN MembershipTable ON HierarchyTable.Staffid = MembershipTable.Memberid INNER JOIN ChurchDesignationTable ON HierarchyTable.HierachyID = ChurchDesignationTable.ChurchDesgID INNER JOIN ChurchDetailTable ON HierarchyTable.ChurchDetailID = ChurchDetailTable.ChurchDetailID AND ChurchDesignationTable.ChurchDesgID = ChurchDetailTable.ChurchDesgID WHERE (HierarchyTable.Week = @week) AND (HierarchyTable.Churchid = @chu)">
                <SelectParameters>
            ...
            <asp:SqlDataSource ID="SqlDataSource5" runat="server" ConnectionString="<%$ ConnectionStrings:ChurchdbConnectionString %>" SelectCommand="SELECT HierarchyTable.SN, ChurchDesignationTable.Branch, ChurchDetailTable.ChurchName, IncomeTable.Income, HierarchyTable.TitheNo, HierarchyTable.Year, HierarchyTable.Month, HierarchyTable.Week, HierarchyTable.Amountword, MembershipTable.FirstName + ' ' + MembershipTable.LastName AS Enterby, HierarchyTable.Datecreated FROM IncomeTable INNER JOIN HierarchyTable ON IncomeTable.ID = HierarchyTable.Incomeid INNER JOIN MembershipTable ON HierarchyTable.Staffid = MembershipTable.Memberid INNER JOIN ChurchDesignationTable ON HierarchyTable.HierachyID = ChurchDesignationTable.ChurchDesgID INNER JOIN ChurchDetailTable ON HierarchyTable.ChurchDetailID = ChurchDetailTable.ChurchDetailID AND ChurchDesignationTable.ChurchDesgID = ChurchDetailTable.ChurchDesgID WHERE (ChurchDetailTable.ChurchName = @member)">
                <SelectParameters>
            ...
            <asp:SqlDataSource ID="SqlDataSource6" runat="server" ConnectionString="<%$ ConnectionStrings:ChurchdbConnectionString %>" SelectCommand="SELECT HierarchyTable.SN, ChurchDesignationTable.Branch, ChurchDetailTable.ChurchName, IncomeTable.Income, HierarchyTable.TitheNo, HierarchyTable.Year, HierarchyTable.Month, HierarchyTable.Week, HierarchyTable.Amountword, MembershipTable.FirstName + ' ' + MembershipTable.LastName AS Enterby, HierarchyTable.Datecreated FROM IncomeTable INNER JOIN HierarchyTable ON IncomeTable.ID = HierarchyTable.Incomeid INNER JOIN MembershipTable ON HierarchyTable.Staffid = MembershipTable.Memberid INNER JOIN ChurchDesignationTable ON HierarchyTable.HierachyID = ChurchDesignationTable.ChurchDesgID INNER JOIN ChurchDetailTable ON HierarchyTable.ChurchDetailID = ChurchDetailTable.ChurchDetailID AND ChurchDesignationTable.ChurchDesgID = ChurchDetailTable.ChurchDesgID WHERE (HierarchyTable.TitheNo = @tithe)">
                <SelectParameters>
