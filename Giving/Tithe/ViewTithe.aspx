<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ViewTithe.aspx.vb" Inherits="ViewTithe" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Tithe View</title>
...
<asp:Menu ID="Menu" runat="server" DataSourceID="SiteMapDataSource1" Orientation="Horizontal"
   OnMenuItemDataBound="OnMenuItemDataBound">
    ...
    <div class="main">
          <div>
            &nbsp;<asp:Button ID="Button2" runat="server" Text="Enter Tithe"  class="a_demo_one" style="font-style: italic; font-weight: 700;" Height="40px" Width="130px" />
            &nbsp;&nbsp;<br />
            <br />
            </div>
...
&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <div>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ChurchdbConnectionString %>" SelectCommand="SELECT TitheTable.SN, TitheTable.Membername, IncomeTable.Income, TitheTable.TitheNo, TitheTable.Month, TitheTable.Week, TitheTable.Amountword, TitheTable.Datecreated, MembershipTable.FirstName + ' ' + MembershipTable.LastName AS Enterby FROM TitheTable INNER JOIN IncomeTable ON TitheTable.Incomeid = IncomeTable.ID INNER JOIN MembershipTable ON TitheTable.Staffid = MembershipTable.Memberid ORDER BY TitheTable.SN">
            </asp:SqlDataSource>
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ChurchdbConnectionString %>" SelectCommand="SELECT TitheTable.SN, TitheTable.Membername, IncomeTable.Income, TitheTable.TitheNo, TitheTable.Month, TitheTable.Week, TitheTable.Amountword, TitheTable.Datecreated, MembershipTable.FirstName + ' ' + MembershipTable.LastName AS enterby FROM TitheTable INNER JOIN IncomeTable ON TitheTable.Incomeid = IncomeTable.ID INNER JOIN MembershipTable ON TitheTable.Staffid = MembershipTable.Memberid WHERE (TitheTable.Churchid = @chu) AND (TitheTable.Datecreated = @date)">
                <SelectParameters>
            ...
            <asp:SqlDataSource ID="SqlDataSource7" runat="server" ConnectionString="<%$ ConnectionStrings:ChurchdbConnectionString %>" SelectCommand="SELECT TitheTable.SN, TitheTable.Membername, TitheTable.PhoneNumber, IncomeTable.Income, TitheTable.TitheNo, TitheTable.Month, TitheTable.Week, TitheTable.Amountword, TitheTable.Datecreated, MembershipTable.FirstName + ' ' + MembershipTable.LastName AS Enterby FROM TitheTable INNER JOIN IncomeTable ON TitheTable.Incomeid = IncomeTable.ID INNER JOIN MembershipTable ON TitheTable.Staffid = MembershipTable.Memberid WHERE (TitheTable.Churchid = @chu) AND (TitheTable.PhoneNumber = @phone)">
                <SelectParameters>
                    <asp:ControlParameter ControlID="txtchurchID" Name="chu" PropertyName="Text" />
