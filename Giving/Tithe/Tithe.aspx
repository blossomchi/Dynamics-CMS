<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Tithe.aspx.vb" Inherits="Tithe" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
   <title>Tithe Record</title>
         ...
         <p>
           ...
           <div class="formbox center">
            <div class="NewFrame">
              <div class="form-group">
                    <asp:Label ID="Label1" runat="server" Text="Members (Only)" CssClass="label"></asp:Label>
                    <asp:DropDownList ID="DrpMember" class="chosen-select" runat="server" DataSourceID="SqlDataSource2" DataTextField="FULLNAME" DataValueField="SN" AutoPostBack="True">
                    </asp:DropDownList>
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ChurchdbConnectionString %>" SelectCommand="SELECT MembershipTable.SN, MembershipTable.FirstName + ' ' + MembershipTable.LastName AS FULLNAME, MembershipTable.Title FROM MembershipTable INNER JOIN ChurchDetailTable ON MembershipTable.ChurchDetailID = ChurchDetailTable.ChurchDetailID WHERE (ChurchDetailTable.ChurchDetailID = @churchID) AND (MembershipTable.Memberid &lt;&gt; N'MEB1')">
                        <SelectParameters>
          ...
          <div class="form-group">
                    <asp:Label ID="Label10" runat="server" Text="Name" CssClass="label" Height="16px"></asp:Label>
                     <asp:TextBox ID="txtName1" runat="server" placeholder="Enter Non Members Name" CssClass="input"></asp:TextBox>
                </div>
              <div class="form-group">
