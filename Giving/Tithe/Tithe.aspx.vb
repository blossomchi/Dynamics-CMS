...
Partial Class Tithe
    ...
    Protected Sub DrpMember_SelectedIndexChanged(sender As Object, e As EventArgs) Handles DrpMember.SelectedIndexChanged
        If DrpMember.SelectedValue = "Select" Then
            ...
            txtPhone.Text = ""
        Else
            Dim gettitheno = (From s In madd.MembershipTables
                       Where s.SN = DrpMember.SelectedValue
                       Select s).SingleOrDefault.TitheId
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        Dim id = From i In a.TitheTables
                 Select i
        If id.Count > 0 Then
        ...
        If DrpMember.SelectedValue = "Select" Then
            'do nothing
        ElseIf DrpMember.SelectedValue <> "Select" Then
            'update tithe number card
            If txtTitheno.Text > 0 Then
                Dim UpdateMemberTithe = madd.MembershipTables.Where(Function(d) d.SN = DrpMember.SelectedValue).SingleOrDefault
                UpdateMemberTithe.TitheId = txtTitheno.Text
                madd.SubmitChanges()
            End If
        End If


            Dim savetithe As New TitheTable With { _
              .Titheid = Lblid.Text, _
              .Incomeid = drpGiving.SelectedValue, _
              .Membername = txtName1.Text, _
            ...
            a.TitheTables.InsertOnSubmit(savetithe)
            a.SubmitChanges()

            If DropPayment.SelectedValue = "Cash" Then

                Dim savepayment As New TithePaymentTable With { _
                  .Titheid = Lblid.Text, _
                  .Incomeid = drpGiving.SelectedValue, _
                  .Datecreated = strDate, _
                  .PaymentMethodid = txtcashM.Text, _
                  .Amount = Text1.Text}
                a.TithePaymentTables.InsertOnSubmit(savepayment)
                a.SubmitChanges()
            ...
            ElseIf DropPayment.SelectedValue = "Card" Then
                ...
                Dim saveBank As New TitheBankPaymentTable With { _
                .Titheid = Lblid.Text, _
               ...
               .CardNumber = TtxcardNo.Text, _
                ...
                .Datecreated = strDate}
                a.TitheBankPaymentTables.InsertOnSubmit(saveBank)
                a.SubmitChanges()
        ...
        Dim message As String = "Tithe Record, Added Successfully!"
            Dim url As String = "Tithe.aspx" ' The page tobe refreshed here!
    ...
    Public Sub AccountPosting()
        Dim getPaymentPerID = From g In madd.TithePaymentTables
        ...
        If checkname = True Then
            ...
            Dim getMemeid = (From s In madd.MembershipTables
                                    Where s.SN = DrpMember.SelectedValue
            ...
            ElseIf hasBankPayment Then
                ...
                Call PostingTitheAccount(strDate, drpGiving.SelectedValue, "Cash", Lblid.Text, "CR", pidBankPayment, txtName1.Text)
        ...
        ElseIf checkname = False Then
            ...
            If hasCash Then
                ...
                Call PostingTitheAccount(strDate, drpGiving.SelectedValue, "Cash", Lblid.Text, "CR", CashAmount, txtName1.Text)
                Call PostingOtherIncome(strDate, drpGiving.SelectedValue, "Cash ", Lblid.Text, "CR", CashAmount, givingName)
            ...
            ElseIf hasETransfer Then
                ...
                Call PostingTitheAccount(strDate, drpGiving.SelectedValue, "Cash", Lblid.Text, "CR", ETransferAmount, txtName1.Text)
                Call PostingOtherIncome(strDate, drpGiving.SelectedValue, "Cash ", Lblid.Text, "CR", ETransferAmount, givingName)
    ...
    Public Sub PostingTitheAccount(ByVal TDate As Date, IncomeID As Integer, Account As String, ADetails As String, TType As String, Amount As Integer, Remark As String)
        ...
        Dim SavePosting As New TitheAccountTable With { _
    ...
    Protected Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        Response.Redirect("ViewTithe.aspx")
    End Sub
