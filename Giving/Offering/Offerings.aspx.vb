...
Partial Class Offerings
    ...
    Protected Sub drpDate_SelectedIndexChanged(sender As Object, e As EventArgs) Handles drpDate.SelectedIndexChanged
        'Dim getDate = (From s In madd.SermonTables
        '             Where s.SN = drpDate.SelectedValue
        '             Select s).SingleOrDefault.Date

        'Dim getTopic = (From s In madd.SermonTables
        '                 Where s.SN = drpDate.SelectedValue
        '                 Select s).SingleOrDefault.SermonTitle

        'Dim getMinister = (From s In madd.SermonTables
        '                Where s.SN = drpDate.SelectedValue
        '                Select s).SingleOrDefault.Pastor

        'txtdate.Text = getDate

        'txtTopic.Text = getTopic

        'txtminister.Text = getMinister
    End Sub
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        If txtdate.Text = "" Then
            ClientScript.RegisterStartupScript(Me.[GetType](), "alert", "alert('Please enter the event date!!!')", True)
            Exit Sub
        End If

        If drpPeriod.SelectedValue = "" Then
            ClientScript.RegisterStartupScript(Me.[GetType](), "alert", "alert('Please select a period!!!')", True)
            Exit Sub
        End If

        If drpPeriod.SelectedValue = "Select" Then
            ClientScript.RegisterStartupScript(Me.[GetType](), "alert", "alert('Please select a period!!!')", True)
            Exit Sub
        End If
        ...
        'This where the code begins

        If DrpGiving.SelectedValue = "2" Then
            Dim strDate As Date
            strDate = Now


            Dim id = From i In a.IncomeOffTables
                     Select i
            If id.Count > 0 Then
            ...
            Dim saveoffering As New IncomeOffTable With {
              .Offeringid = Lblid.Text,
              .EventDate = txtdate.Text,
              .Topic = txtTopic.Text,
              .Period = drpPeriod.SelectedValue,
              .Minister = txtminister.Text,
              .incomeid = DrpGiving.SelectedValue,
              .Amountword = divDisplayWords.Text,
              .Name = txtName1.Text,
              .Datecreated = strDate,
              .Staffid = txtStaffID.Text,
              .Churchid = txtchurchID.Text}

            a.IncomeOffTables.InsertOnSubmit(saveoffering)
            a.SubmitChanges()

            If DropPayment.SelectedValue = "Cash" Then

                Dim savepayment As New IncomePaymentTable With {
                  .Offeringid = Lblid.Text,
                  .Incomeid = DrpGiving.SelectedValue,
                  .DateCreated = strDate,
                  .PaymentMethodid = txtcashM.Text,
                  .Amount = Text1.Text}
                a.IncomePaymentTables.InsertOnSubmit(savepayment)
                a.SubmitChanges()
            ...
            ElseIf DropPayment.SelectedValue = "Card" Then
                ...
                Dim saveBank As New IncomeBankPaymentTable With {
                .Offeringid = Lblid.Text,
                .Paymentid = txtcashM.Text,
                .Bankid = DrpBanks.SelectedValue,
               .CardNumber = TtxcardNo.Text,
                .AccountName = txtAccountName.Text,
                .ExpireDate = txtExpire.Text,
                .Datecreated = strDate}
                a.IncomeBankPaymentTables.InsertOnSubmit(saveBank)
                a.SubmitChanges()
            ...
            Call AccountPosting()
            ClientScript.RegisterStartupScript(Me.[GetType](), "alert", "alert('Offering, Added Successfully!')", True)
            Response.Redirect("Offerings.aspx")


        ElseIf DrpGiving.SelectedValue = "13" Then
            'tithe cumulative
            Dim strDate As Date
            strDate = Now
            ...
            Call AccountPosting()
            ClientScript.RegisterStartupScript(Me.[GetType](), "alert", "alert('Tithe cumulative, Added Successfully!')", True)
            Response.Redirect("Offerings.aspx")

        ElseIf DrpGiving.SelectedValue = "3" Then
            ...
            Dim saveoffering As New IncomeOffTable With { _
              .Offeringid = Lblid.Text, _
              .EventDate = txtdate.Text, _
              .Topic = txtTopic.Text, _
              .Period = drpPeriod.SelectedValue, _
              .Minister = txtminister.Text, _
              .incomeid = DrpGiving.SelectedValue, _
              .Amountword = divDisplayWords.Text, _
              .Name = txtName1.Text, _
            ...
            If DropPayment.SelectedValue = "Cash" Then
                ...
                Dim savepayment As New IncomePaymentTable With { _
                  .Offeringid = Lblid.Text, _
                  .Incomeid = DrpGiving.SelectedValue, _
                  .DateCreated = strDate, _
            ...
            ElseIf DropPayment.SelectedValue = "Card" Then
                ...
                Dim saveBank As New IncomeBankPaymentTable With { _
                .Offeringid = Lblid.Text, _
            ...
            ClientScript.RegisterStartupScript(Me.[GetType](), "alert", "alert('Vow Offering, Added Successfully!')", True)
            Response.Redirect("Offerings.aspx")



        ElseIf DrpGiving.SelectedValue = "4" Then
            Dim strDate As Date
            strDate = Now
            ...
            ClientScript.RegisterStartupScript(Me.[GetType](), "alert", "alert('Seed of Faith, Added Successfully!')", True)
            Response.Redirect("Offerings.aspx")



        ElseIf DrpGiving.SelectedValue = "5" Then
            Dim strDate As Date
            strDate = Now
            ...
            ClientScript.RegisterStartupScript(Me.[GetType](), "alert", "alert('First Fruit Offering, Added Successfully!')", True)
            Response.Redirect("Offerings.aspx")


        ElseIf DrpGiving.SelectedValue = "7" Then
            Dim strDate As Date
            strDate = Now
            ...
            ClientScript.RegisterStartupScript(Me.[GetType](), "alert", "alert('Media Offering, Added Successfully!')", True)
            Response.Redirect("Offerings.aspx")

        ElseIf DrpGiving.SelectedValue = "8" Then
            Dim strDate As Date
            strDate = Now
            ...
            ClientScript.RegisterStartupScript(Me.[GetType](), "alert", "alert('Children Offering, Added Successfully!')", True)
            Response.Redirect("Offerings.aspx")


        ElseIf DrpGiving.SelectedValue = "9" Then
            Dim strDate As Date
            strDate = Now
            ...
            ClientScript.RegisterStartupScript(Me.[GetType](), "alert", "alert('Other Offering, Added Successfully')", True)
            Response.Redirect("Offerings.aspx")


        ElseIf DrpGiving.SelectedValue = "10" Then
            Dim strDate As Date
            strDate = Now
            ...
            ClientScript.RegisterStartupScript(Me.[GetType](), "alert", "alert('Project Offering, Added Successfully')", True)
            Response.Redirect("Offerings.aspx")

        ElseIf DrpGiving.SelectedValue = "11" Then
            Dim strDate As Date
            strDate = Now
            ...
            ClientScript.RegisterStartupScript(Me.[GetType](), "alert", "alert('Faith Contact Offering, Added Successfully!')", True)
            Response.Redirect("Offerings.aspx")

            ''This Code is Displaying Saved Message and Reload / Refresh The Page
            'Dim message As String = "Faith Contact Offering, Added Successfully!"
            'Dim url As String = "Offerings.aspx" ' The page to be refreshed here!
    ...
    Public Sub AccountPosting()
        Dim getPaymentPerID = From g In madd.IncomePaymentTables
                              Where g.Offeringid = Lblid.Text
                              Group New With {g} By
                              g.PaymentMethodid,
                              g.Offeringid,
                              g.DateCreated
                              Into gr = Group
                              Select New With {
                                  .id = gr.Max(Function(i) i.g.SN),
                                  .OfferingID = gr.FirstOrDefault.g.Offeringid,
                                  .PaymentMethodid = gr.FirstOrDefault.g.PaymentMethodid,
                                  .Amount = gr.Sum(Function(s) s.g.Amount),
        ...
        ElseIf DrpGiving.SelectedValue = "13" Then
            ...
            If hasCash Then
                ...
                Call PostingTitheAccount(strDate, DrpGiving.SelectedValue, "Cash", Lblid.Text, "CR", CashAmount, txtName1.Text)

            ElseIf hasCard Then
                Call PostingCash(strDate, "Bank", "Cash", Lblid.Text, "Card", "DR ", CardAmount, givingName)

                Call PostingTitheAccount(strDate, DrpGiving.SelectedValue, "Cash", Lblid.Text, "CR", CardAmount, txtName1.Text)


            ElseIf hasChegue Then
                Call PostingCash(strDate, "Bank", "Cash", Lblid.Text, "Chegue", "DR ", ChequeAmount, givingName)

                Call PostingTitheAccount(strDate, DrpGiving.SelectedValue, "Cash", Lblid.Text, "CR", ChequeAmount, txtName1.Text)

            ElseIf hasBankPayment Then
                Call PostingCash(strDate, "Bank", "Cash", Lblid.Text, "Bank Payment", "DR ", BankPaymentAmount, givingName)

                Call PostingTitheAccount(strDate, DrpGiving.SelectedValue, "Cash", Lblid.Text, "CR", BankPaymentAmount, txtName1.Text)


            ElseIf hasETransfer Then
                Call PostingCash(strDate, "Bank", "Cash", Lblid.Text, "Electronic Transfer", "DR ", ETransferAmount, givingName)

                Call PostingTitheAccount(strDate, DrpGiving.SelectedValue, "Cash", Lblid.Text, "CR", ETransferAmount, txtName1.Text)
        ...
        ElseIf DrpGiving.SelectedValue = "3" Then
            ...
            If hasCash Then
                ...
                Call PostingOfferingAccount(strDate, DrpGiving.SelectedValue, "Cash", Lblid.Text, "CR", CashAmount, txtName1.Text)
            ...
            ElseIf hasCard Then
                ...
                Call PostingOfferingAccount(strDate, DrpGiving.SelectedValue, "Cash", Lblid.Text, "CR", CardAmount, txtName1.Text)


            ElseIf hasChegue Then
                Call PostingCash(strDate, "Bank", "Cash", Lblid.Text, "Chegue", "DR ", ChequeAmount, givingName)

                Call PostingOfferingAccount(strDate, DrpGiving.SelectedValue, "Cash", Lblid.Text, "CR", ChequeAmount, txtName1.Text)

            ElseIf hasBankPayment Then
                Call PostingCash(strDate, "Bank", "Cash", Lblid.Text, "Bank Payment", "DR ", BankPaymentAmount, givingName)

                Call PostingOfferingAccount(strDate, DrpGiving.SelectedValue, "Cash", Lblid.Text, "CR", BankPaymentAmount, txtName1.Text)


            ElseIf hasETransfer Then
                Call PostingCash(strDate, "Bank", "Cash", Lblid.Text, "Electronic Transfer", "DR ", ETransferAmount, givingName)

                Call PostingOfferingAccount(strDate, DrpGiving.SelectedValue, "Cash", Lblid.Text, "CR", ETransferAmount, txtName1.Text)
    ...
    End Sub
    Public Sub PostingTitheAccount(ByVal TDate As Date, IncomeID As Integer, Account As String, ADetails As String, TType As String, Amount As Integer, Remark As String)
        Dim staff = txtStaffID.Text

        Dim SavePosting As New TitheAccountTable With {
            .TranscationDate = TDate,
            .incomeid = IncomeID,
            .AccountName = Account,
            .Accountdetails = ADetails,
            .Transcationtype = TType,
            .Amount = Amount,
            .Remark = Remark,
            .Datecreated = Now,
            .StaffId = staff}
        madd.TitheAccountTables.InsertOnSubmit(SavePosting)
        madd.SubmitChanges()

    End Sub
    Public Sub PostingOfferingAccount(ByVal TDate As Date, IncomeID As Integer, Account As String, ADetails As String, TType As String, Amount As Integer, Remark As String)
        Dim staff = txtStaffID.Text

        Dim SavePosting As New IncomeAccountTable With { _
            ...
            .Datecreated = Now, _
            .StaffId = staff}
        madd.IncomeAccountTables.InsertOnSubmit(SavePosting)
        madd.SubmitChanges()
    ...
    Protected Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        Response.Redirect("OfferingView.aspx")
    End Sub
    ...
    Protected Sub ChildDatePicker_SelectedDateChanged(sender As Object, e As Telerik.Web.UI.Calendar.SelectedDateChangedEventArgs) Handles ChildDatePicker.SelectedDateChanged
        txtdate.Text = ChildDatePicker.SelectedDate
    End Sub
End Class
