<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ViewWelfare.aspx.vb" Inherits="ViewWelfare" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
   <title>Welfare View</title>
...
<asp:Menu ID="Menu" runat="server" DataSourceID="SiteMapDataSource1" Orientation="Horizontal"
   OnMenuItemDataBound="OnMenuItemDataBound">
    ...
    <div class="main">
          <div>
            &nbsp;<asp:Button ID="Button2" runat="server" Text="Add Welfare"  class="a_demo_one" style="font-style: italic; font-weight: 700;" Height="40px" Width="140px" />
            &nbsp;&nbsp;<br />
            <br />
            </div>
...
&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <div>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ChurchdbConnectionString %>" SelectCommand="SELECT WelfareMainTable.SN, WelfareMainTable.DateRaised, WelfareMainTable.Amountword, WelfareMainTable.Datecreated, WelfareMainTable.year, MembershipTable.FirstName + '  ' + MembershipTable.LastName AS Createdby FROM WelfareMainTable INNER JOIN MembershipTable ON WelfareMainTable.Staffid = MembershipTable.Memberid WHERE (WelfareMainTable.Churchid = @chu) ORDER BY WelfareMainTable.SN">
                <SelectParameters>
