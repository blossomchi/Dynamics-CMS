<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Pledgeview.aspx.vb" Inherits="Pledgeview" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
      <title>Pledge View</title>
...
<asp:Menu ID="Menu" runat="server" DataSourceID="SiteMapDataSource1" Orientation="Horizontal"
   OnMenuItemDataBound="OnMenuItemDataBound">
    ...
    <div class="main">
        ...
        <div>
            &nbsp;<asp:Button ID="Button1" runat="server" Text="Enter Pledge" class="a_demo_one" style="font-style: italic; font-weight: 700;" Height="40px" Width="160px"/>
            <br />
            <br />
...
&nbsp;<asp:DropDownList  class="chosen-select" ID="DrpCriteria2" runat="server"  Height="15px" Width="200px" Visible="False" AutoPostBack="True">
        ...
        <div>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ChurchdbConnectionString %>" SelectCommand="SELECT PledgeTable.SN, IncomeTable.Income, PledgeTable.MemberName, PledgeTable.Phone, PledgeTable.Project, PledgeTable.frequency, PledgeTable.Amountword, MembershipTable.FirstName + ' ' + MembershipTable.LastName AS Enterby, PledgeTable.Datecreated FROM PledgeTable INNER JOIN IncomeTable ON PledgeTable.incomeid = IncomeTable.ID INNER JOIN MembershipTable ON PledgeTable.Staffid = MembershipTable.Memberid WHERE (PledgeTable.Churchid = @chu)">
                <SelectParameters>
