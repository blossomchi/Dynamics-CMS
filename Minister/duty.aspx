<%@ Page Language="VB" AutoEventWireup="false" CodeFile="duty.aspx.vb" Inherits="duty" %>
         ...
         <p>
            ...
            <div class="formframe">
                <div class="form-group">
                    <asp:Label ID="Label1" runat="server" Text="Duty Name" CssClass="label"></asp:Label>
                ...
                <div class="form-group">
                   ...
                   <div class="form-group">
                    <asp:TextBox ID="txtchurchID" runat="server" Visible="False" Font-Size="9px" Width="20px"></asp:TextBox>
                     ...
                     <asp:TextBox ID="txtDutyId" runat="server" Font-Size="XX-Small" Visible="False" Width="20px" Height="19px"></asp:TextBox>
                       </div>
                  <div class="form-group">
            ...
            <asp:GridView ID="gridLocation" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="SqlDataSource1" Font-Size="Medium" Height="30px" Width="634px" AllowPaging="True" AllowSorting="True" ForeColor="#333333" GridLines="None" PageSize="6">
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="DutyDescp" HeaderText="DutyDescp" SortExpression="DutyDescp" >
                    </asp:BoundField>
                     <asp:TemplateField>
                                          <ItemTemplate>
                ...
                <SortedDescendingHeaderStyle BackColor="#15524A" />
                     ...
                     <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ChurchdbConnectionString %>" SelectCommand="SELECT [SN], [DutyName], [DutyDescp] FROM [DutyTable]"></asp:SqlDataSource>
