<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AddVisitor.aspx.vb" Inherits="AddVisitor" %>
...
<body>
    ...
    <div class="header">
        ...
        <br />
                    <asp:Label ID="lblserviceid" runat="server" CssClass="label" Visible="False"></asp:Label>
    ...
    <div class="main">
            <asp:Button ID="Button1" runat="server" Text="View Visitor" class="a_demo_one"  Width="130px" Height="40px" />
            &nbsp;&nbsp;<br />
         <p>
            ...
            <div class="formbox center">
             <div class="NewFrame">
                <div class="form-group">
                    <asp:Label ID="Label1" runat="server" Text="Visitor" CssClass="label"></asp:Label>
                  
                    <asp:DropDownList ID="DropVisitor" CssClass="drop-down" runat="server">
                        <asp:ListItem>First Timer</asp:ListItem>
                   ...
                   <div class="form-group">
                    <asp:Label ID="Label15" runat="server" Text="FirstName:" CssClass="label"></asp:Label>
                ...
                <div class="form-group">
                    <asp:Label ID="Label6" runat="server" Text="Respond:" CssClass="label"></asp:Label>
                    <asp:DropDownList ID="DropRespond" CssClass="drop-down" runat="server">
                        <asp:ListItem>Staying</asp:ListItem>
                        <asp:ListItem>Visiting</asp:ListItem>
                        <asp:ListItem>No Respond</asp:ListItem>
                    </asp:DropDownList>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <asp:Label ID="Label8" runat="server" Text="Nationality" CssClass="label"></asp:Label>
                    <asp:DropDownList id="ddlCountry" class="chosen-select" runat="server">
