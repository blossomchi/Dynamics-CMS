<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EditChildren.aspx.vb" Inherits="Children" %>
...
<head runat="server">
    <title>Edit Children Department</title>
...
<DatePopupButton ImageUrl="" HoverImageUrl=""></DatePopupButton>
                ...
                <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <asp:TextBox runat="server"  CssClass="input" ID="txtMemID" placeholder="DD/MM/YYYY" AutoPostBack="True" Visible="False" Width="20px" ></asp:TextBox>
    ...
    <p><a href="http://www.rolofdynamics.com/">RolofDynamics</a> © 2016 - <% = Year(Now)%>. All rights reserved..</p>
        ...
        <script type="text/javascript">
             var pageUrl = '<%=ResolveUrl("EditChildren.aspx") %>';
             $(function () {
