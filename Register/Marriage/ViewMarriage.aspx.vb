...
Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Protected Sub DrpSorted_SelectedIndexChanged(sender As Object, e As EventArgs) Handles DrpSorted.SelectedIndexChanged
        ...
        ElseIf DrpSorted.SelectedValue = "Month" Then
            ...
            Dim services = From y In madd.MarriageTables
    ...
    Protected Sub GridMonth_SelectedIndexChanged(sender As Object, e As EventArgs) Handles GridMonth.SelectedIndexChanged
        Dim getID = GridMonth.SelectedRow.Cells(0).Text

        Session("marriageID") = getID

        Response.Redirect("MarraigeEdit.aspx")
    End Sub
