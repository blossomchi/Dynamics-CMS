    ...
    <div class="main">
        <div class="formbox">
           <div class="NewFrameex">
               ...
               <div class="form-group">
                    <asp:Label ID="Label24" runat="server" Text="Middle Names" CssClass="label"></asp:Label>
                    <asp:TextBox ID="txtMiddle" runat="server" CssClass="input"></asp:TextBox>
                </div>
                   <div class="form-group">
                    <asp:Label ID="Label15" runat="server" Text="Family Name" CssClass="label"></asp:Label>
                ...
                <div class="form-group">
                    ...
                    <asp:DropDownList ID="dropGender" runat="server" class="chosen-select" CssClass="drop-down">
         ...
         <div class="NewFrameex">
                   ...
                   <asp:DropDownList ID="Dropmarital" runat="server" class="chosen-select"  AutoPostBack="True" Width="198px">
                 ...
                 <div class="form-group">
                    ...
                    <telerik:RadDatePicker ID="MarrigeDatePicker" Runat="server" Culture="en-US" Visible="False" FocusedDate="1950-01-01" MinDate="1950-01-01">
...
<DatePopupButton ImageUrl="" HoverImageUrl=""></DatePopupButton>
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                     <asp:Label ID="Label20" runat="server" Text="Spoken" CssClass="label"></asp:Label>
                        <asp:Label ID="Label33" runat="server" Text=" languages"></asp:Label>
            ...
            <div class="NewFrameex">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    <asp:DropDownList ID="DrpTitle" class="chosen-select" runat="server" CssClass="drop-down">
                    ...
                    <asp:DropDownList ID="DropServiceunit" runat="server" class="chosen-select" CssClass="drop-down" DataSourceID="SqlDataSource1" DataTextField="ServiceName" DataValueField="ServiceId" AutoPostBack="True">
             ...
             <div class="form-group">
                    <table class="auto-style1">
                        <tr>
                            ...
                            <td>
                    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataSourceID="SqlDataSourcePending" PageSize="4" ShowHeader="False" Visible="False" Width="159px" GridLines="Horizontal">
                        <Columns>
                ...
                <div class="form-group">
                    ...
                    <asp:DropDownList ID="cbMemGroup" runat="server" class="chosen-select" CssClass="drop-down" DataSourceID="SqlDataSource5" DataTextField="GroupName" DataValueField="ID">
                        <asp:ListItem Enabled="False" Selected="True">Select</asp:ListItem>
                        <asp:ListItem Enabled="False" Selected="True">Deslect</asp:ListItem>
                    </asp:DropDownList>
            ...
            <div class="form-group">
                 ...
                 <div class="form-group">
                   ...
                   <div class="form-group">
                    <asp:Label ID="Label25" runat="server" Text="Location" CssClass="label"></asp:Label>
                      <asp:DropDownList ID="CBLocation" class="chosen-select" runat="server" DataSourceID="SqlDataSource6" DataTextField="Adress" DataValueField="Adress" AutoPostBack="True" Width="198px">
                      </asp:DropDownList>
                ...
                <div class="form-group">
                    ...
                    <asp:TextBox ID="txtMembername" runat="server" Visible="False" Font-Size="9px" Width="20px"></asp:TextBox>
                     ...
                     <asp:TextBox ID="txtPictureName" runat="server" Font-Size="XX-Small" Visible="False" Width="20px" Height="19px"></asp:TextBox>
