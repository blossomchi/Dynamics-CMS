<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DeburseCash.aspx.vb" Inherits="DeburseCash" %>
...
<DatePopupButton ImageUrl="" HoverImageUrl=""></DatePopupButton>
                      ...
                      <asp:TextBox ID="txtTransDate"  CssClass="input" runat="server" Visible="False" Width="20px"></asp:TextBox>
                </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <asp:TextBox ID="txtDescrip" runat="server" CssClass="input" placeholder="Little Description" TextMode="MultiLine" ></asp:TextBox>
                </div>
