<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CashBookView.aspx.vb" Inherits="CashBookView" %>
...
<asp:Menu ID="Menu" runat="server" DataSourceID="SiteMapDataSource1" Orientation="Horizontal"
   OnMenuItemDataBound="OnMenuItemDataBound">
    ...
    <div class="main">
        <asp:Button ID="Button3" runat="server" Text="Recieve Cash " class="a_demo_one"  Width="120px" Height="40px" />  &nbsp; &nbsp; &nbsp; &nbsp;<asp:Button ID="Button1" runat="server" Text="Disburse Cash" class="a_demo_one"  Width="120px" Height="40px" />
        <div>
                <br />
         </div>
        <div>
            <asp:GridView ID="GVAllMinister" runat="server" Width="1150px" DataSourceID="SqlDataSource1" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="6" ForeColor="#333333" GridLines="None" PageSize="15" ShowFooter="True" style="font-size: small; font-weight: 700;" BorderStyle="Solid">
                ...
                <Columns>
                    <asp:BoundField DataField="Transactiondate" HeaderText="Transaction_Date" SortExpression="Transactiondate" />
                    ...
                    <asp:BoundField DataField="Accountdetails" HeaderText="First Details" SortExpression="Accountdetails" />
                    <asp:BoundField DataField="Accountdetails1" HeaderText="Second Dtails" SortExpression="Accountdetails1" />
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ChurchdbConnectionString %>" SelectCommand="SELECT Cash_BookTable.Transactiondate, Cash_BookTable.Cash_Bank, Cash_BookTable.AccountName, Cash_BookTable.Accountdetails, Cash_BookTable.Accountdetails1, Cash_BookTable.TransactionType, Cash_BookTable.Amount, Cash_BookTable.Remark, MembershipTable.FirstName + ' ' + MembershipTable.LastName AS Enterby, Cash_BookTable.Datecreated FROM Cash_BookTable INNER JOIN MembershipTable ON Cash_BookTable.Staffid = MembershipTable.Memberid WHERE (MembershipTable.ChurchDetailID = @chu) ORDER BY Cash_BookTable.Transactiondate">
                <SelectParameters>
