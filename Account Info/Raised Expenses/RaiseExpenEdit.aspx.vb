...
Partial Class RaiseExpenses
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            txtRaiseid.Text = Session("Raiseid")

            If txtRaiseid.Text = "" Then
            ...
            Else
                ...
                Dim getAllExpensInf = madd.RaiseExpensesHdTables.Where(Function(q) q.ID = txtRaiseid.Text).SingleOrDefault()

                PnlDesc.Visible = True
                Dim exphead As String
                exphead = getAllExpensInf.ExpenseHead
                If exphead = "" Then
                    drpExpenseHd.Items.Remove("Select")
                ...
                Else
                    drpExpenseHd.DataBind()
                    drpExpenseHd.SelectedValue = exphead
                    drpExpenseHd.Enabled = True

                    txtwelfaresort.Text = exphead
                ...
                supplier = getAllExpensInf.Supplerid
                If supplier = "" Then
                    drpPayee.DataBind()
                ...
                Else
                    drpPayee.DataBind()
                    drpPayee.SelectedValue = supplier
                ...
                amout = getAllExpensInf.Amount
                If amout = 0 Then
                    txtAmount.Text = 0.0
                Else
                    ' txtAmount.Text = amout
                    txtAmount.Text = Format(Decimal.Round(amout, 2), "₦#,#.00")

                    LBAmount.Text = txtAmount.Text
                End If
    ...
    Protected Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        If checkPayment Then
            For Each s1 In (From y In madd.RaiseExpenPaymentTables
                              Where (y.RaiseexpHdid = txtRaiseid.Text)
                                   Select y)
    ...
    Protected Sub btnReset_Click(sender As Object, e As EventArgs) Handles btnReset.Click
        If drpPayee.SelectedValue = "Select" Then
            ClientScript.RegisterStartupScript(Me.[GetType](), "alert", "alert('Please payee!!!')", True)
            Exit Sub
        End If
        Dim updateInfo = madd.RaiseExpensesHdTables.Where(Function(q) q.ID = txtRaiseid.Text).SingleOrDefault

        updateInfo.Supplerid = drpPayee.SelectedValue
        madd.SubmitChanges()
        ...
        LBAmount.Text = madd.RaiseExpensesHdTables.Where(Function(q) q.ID = txtRaiseid.Text).SingleOrDefault.Amount
    End Sub
End Class
