<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RaiseExpenEdit.aspx.vb" Inherits="RaiseExpenses" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Edit Expenses Raise</title>
    ...
    <div class="main">
        ...
        <asp:Panel ID="PnlMain" runat="server">
            <div class="formbox">
                ...
                <asp:Button ID="btnSave" runat="server"  Text="Save" Width="85px" Height="25px" Visible="False"/>

                      <asp:Button ID="btnReset" runat="server" Height="25px" Text="Update" Width="85px" />
