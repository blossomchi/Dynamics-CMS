<%@ Page Language="VB" AutoEventWireup="false" CodeFile="OtherIncome.aspx.vb" Inherits="OtherIncome" %>
...
<asp:Menu ID="Menu" runat="server" DataSourceID="SiteMapDataSource1" Orientation="Horizontal"
   OnMenuItemDataBound="OnMenuItemDataBound">
    ...
    <div class="main">
        ...
        <div>
            &nbsp;<asp:Button ID="Button1" runat="server" Text="Account" class="a_demo_one" style="font-style: italic; font-weight: 700;" Height="40px" Width="100px"/>
            <br />
            <br />
...
&nbsp;<asp:DropDownList  class="chosen-select" ID="DrpCriteria2" runat="server"  Height="15px" Width="200px" Visible="False" AutoPostBack="True">
        ...
        <div>
            <asp:GridView ID="GVAllMinister" runat="server" Width="1150px" DataSourceID="SqlDataSource1" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="6" ForeColor="#333333" GridLines="None" PageSize="20" ShowFooter="True" style="font-size: small; font-weight: 700;" CellSpacing="2" BorderStyle="Solid">
                ...
                <Columns>
                    <asp:BoundField DataField="TransactionDate" HeaderText="TransactionDate" SortExpression="TransactionDate" DataFormatString="{0:dd/MM/yyyy}" />
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ChurchdbConnectionString %>" SelectCommand="SELECT Other_incomeAccountTable.TransactionDate, IncomeTable.Income, Other_incomeAccountTable.AccountName, Other_incomeAccountTable.Accountdetails, Other_incomeAccountTable.Transcationtype, Other_incomeAccountTable.Amount, Other_incomeAccountTable.Remark, Other_incomeAccountTable.Datecreated, MembershipTable.FirstName + ' ' + MembershipTable.LastName AS Enterby FROM Other_incomeAccountTable INNER JOIN IncomeTable ON Other_incomeAccountTable.Other_incomeid = IncomeTable.ID INNER JOIN MembershipTable ON Other_incomeAccountTable.StaffId = MembershipTable.Memberid">
            </asp:SqlDataSource>
