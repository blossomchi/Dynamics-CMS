<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Pension.aspx.vb" Inherits="Tithe" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
   <title>Pension Record</title>
...
<body>
    ...
    <div class="main">
          <asp:Button ID="Button3" runat="server" Text="View Pension" class="a_demo_one"  Width="180px" Height="40px" ToolTip="Click to view church tithe record" />
         <p>
           ...
           <div class="formbox center">
            <div class="NewFrame">
                 <div class="form-group">
                    <asp:Label ID="Label20" runat="server" Text="Hierarchy Churches" CssClass="label"></asp:Label>
                    <asp:DropDownList ID="CBHierarchy" class="chosen-select" runat="server" DataSourceID="HierarchyDS" DataTextField="Branch" DataValueField="ChurchDesgID" AutoPostBack="True">
                    </asp:DropDownList>
                     <asp:SqlDataSource ID="HierarchyDS" runat="server" ConnectionString="<%$ ConnectionStrings:ChurchdbConnectionString %>" SelectCommand="SELECT ChurchDesgID, Branch FROM ChurchDesignationTable"></asp:SqlDataSource>
                </div>
              <div class="form-group">
                    <asp:Label ID="Label1" runat="server" Text="Churches" CssClass="label"></asp:Label>
                    <asp:DropDownList ID="DrpChurches" class="chosen-select" runat="server" DataSourceID="SqlDataSource2" DataTextField="ChurchName" DataValueField="ChurchDetailID" AutoPostBack="True">
                    </asp:DropDownList>
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ChurchdbConnectionString %>" SelectCommand="SELECT ChurchDetailTable.ChurchDesgID, ChurchDesignationTable.Branch, ChurchDetailTable.ChurchDetailID, ChurchDetailTable.ChurchName FROM ChurchDetailTable INNER JOIN ChurchDesignationTable ON ChurchDetailTable.ChurchDesgID = ChurchDesignationTable.ChurchDesgID WHERE (ChurchDetailTable.ChurchDesgID = @ID)">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="txtHieID" Name="ID" PropertyName="Text" />
                        </SelectParameters>
                    </asp:SqlDataSource>
                </div>
          <div class="form-group">
            ...
            <div class="form-group">
                    <asp:Label ID="Label2" runat="server" Text="Tithe No" CssClass="label" Visible="False"></asp:Label>
                    <asp:TextBox ID="txtTitheno" runat="server" CssClass="input" placeholder="Enter Tithe Number" Height="16px" Visible="False" ></asp:TextBox>
                </div>
           ...
           <div class="form-group">
                    <asp:Label ID="Label8" runat="server" Text="Giving" CssClass="label"></asp:Label>
                      ...
                      <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:ChurchdbConnectionString %>" SelectCommand="SELECT ID, Income FROM IncomeTable WHERE (Income = N'Pension')"></asp:SqlDataSource>
                </div>
        ...
        maxlength="9" Height="16px"  ></asp:TextBox>
         ...
         <div class="form-group">
              ...
              onKeyUp="javascript:Add();" Visible="False"></asp:TextBox>
                     <asp:TextBox ID="txtHieID" runat="server" Font-Size="XX-Small" Width="20px" onkeypress="return onlyNumbers();" 
              onKeyUp="javascript:Add();" Visible="False"></asp:TextBox>
                       </div>
