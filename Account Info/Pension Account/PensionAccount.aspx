<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PensionAccount.aspx.vb" Inherits="Tithe_Account" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
      <title>Pension Account</title>
    ...
    <div class="main">
        ...
        <div>
            <asp:GridView ID="GridTithe" runat="server" Width="1150px" DataSourceID="SqlDataSource1" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="6" ForeColor="#333333" GridLines="None" PageSize="20" ShowFooter="True" style="font-size: small; font-weight: 700;" CellSpacing="2" BorderStyle="Solid">
                ...
                <Columns>
                    <asp:BoundField DataField="TranscationDate" HeaderText="TranscationDate" SortExpression="TranscationDate" />
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ChurchdbConnectionString %>" SelectCommand="SELECT PensionAccountTable.TranscationDate, ChurchDesignationTable.Branch, ChurchDetailTable.ChurchName, IncomeTable.Income, PensionAccountTable.AccountName, PensionAccountTable.Accountdetails, PensionAccountTable.Transcationtype, PensionAccountTable.Amount, PensionAccountTable.Remark, PensionAccountTable.Datecreated, MembershipTable.FirstName + ' ' + MembershipTable.LastName AS [Entered By] FROM ChurchDesignationTable INNER JOIN PensionAccountTable ON ChurchDesignationTable.ChurchDesgID = PensionAccountTable.HirerchyID INNER JOIN ChurchDetailTable ON PensionAccountTable.ChurchDetailsID = ChurchDetailTable.ChurchDetailID INNER JOIN IncomeTable ON PensionAccountTable.incomeid = IncomeTable.ID INNER JOIN MembershipTable ON PensionAccountTable.StaffId = MembershipTable.Memberid ORDER BY PensionAccountTable.TranscationDate DESC">
            </asp:SqlDataSource>
            ...
            <asp:SqlDataSource ID="SqlTitle" runat="server" ConnectionString="<%$ ConnectionStrings:ChurchdbConnectionString %>" SelectCommand="SELECT PensionAccountTable.TranscationDate, ChurchDesignationTable.Branch, ChurchDetailTable.ChurchName, IncomeTable.Income, PensionAccountTable.AccountName, PensionAccountTable.Accountdetails, PensionAccountTable.Transcationtype, PensionAccountTable.Amount, PensionAccountTable.Remark, PensionAccountTable.Datecreated, MembershipTable.FirstName + ' ' + MembershipTable.LastName AS [Entered By] FROM ChurchDesignationTable INNER JOIN PensionAccountTable ON ChurchDesignationTable.ChurchDesgID = PensionAccountTable.HirerchyID INNER JOIN ChurchDetailTable ON PensionAccountTable.ChurchDetailsID = ChurchDetailTable.ChurchDetailID INNER JOIN IncomeTable ON PensionAccountTable.incomeid = IncomeTable.ID INNER JOIN MembershipTable ON PensionAccountTable.StaffId = MembershipTable.Memberid WHERE (PensionAccountTable.TranscationDate = @transdate) ORDER BY PensionAccountTable.TranscationDate DESC">
                <SelectParameters>
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ChurchdbConnectionString %>" SelectCommand="SELECT PensionAccountTable.TranscationDate, ChurchDesignationTable.Branch, ChurchDetailTable.ChurchName, IncomeTable.Income, PensionAccountTable.AccountName, PensionAccountTable.Accountdetails, PensionAccountTable.Transcationtype, PensionAccountTable.Amount, PensionAccountTable.Remark, PensionAccountTable.Datecreated, MembershipTable.FirstName + ' ' + MembershipTable.LastName AS [Entered By] FROM ChurchDesignationTable INNER JOIN PensionAccountTable ON ChurchDesignationTable.ChurchDesgID = PensionAccountTable.HirerchyID INNER JOIN ChurchDetailTable ON PensionAccountTable.ChurchDetailsID = ChurchDetailTable.ChurchDetailID INNER JOIN IncomeTable ON PensionAccountTable.incomeid = IncomeTable.ID INNER JOIN MembershipTable ON PensionAccountTable.StaffId = MembershipTable.Memberid WHERE (PensionAccountTable.Datecreated = @transdate) ORDER BY PensionAccountTable.TranscationDate DESC">
                <SelectParameters>
                    <asp:ControlParameter ControlID="txtSelectedDate" Name="transdate" PropertyName="Text" />
                </SelectParameters>
            </asp:SqlDataSource>
