<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Serviceunit.aspx.vb" Inherits="Serviceunit" %>
         ...
         <p>
            ...
            <div class="formframe">
                <div class="form-group">
                    <asp:Label ID="Label1" runat="server" Text="Service Name" CssClass="label"></asp:Label>
                ...
                <div class="item-right">
                    ...
                    <asp:GridView ID="GridUnit" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" Height="100px" PageSize="6" style="font-size: medium" Width="500px" AllowPaging="True" AllowSorting="True">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="SeviceDescrip" HeaderText="Description" SortExpression="SeviceDescrip">
                            <HeaderStyle HorizontalAlign="Left" />
                            </asp:BoundField>
                             <asp:TemplateField>
                                          <ItemTemplate>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ChurchdbConnectionString %>" SelectCommand="SELECT [SN], [ServiceName], [SeviceDescrip] FROM [UnitTable] ORDER BY [SN]"></asp:SqlDataSource>
