<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EditHomecell.aspx.vb" Inherits="Homecell" %>
...
<body>
  ...
  <div class="form-group">
                 ...
                 <div class="form-group">
                    <asp:Label ID="Label3" runat="server" Text="Leader" CssClass="label"></asp:Label>
                 ...
                 <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <asp:TextBox ID="txtfulname" runat="server" Visible="False" Font-Size="9px" Width="20px"></asp:TextBox>
                       ...
                       <asp:TextBox ID="txHomeSN" runat="server" Visible="False" Width="16px"></asp:TextBox>
